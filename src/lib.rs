// src/lib.rs
/*
 * Core library for WebhookHandler
 */
...
#[derive(Debug)]
pub struct WebhookHandlerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WebhookHandlerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WebhookHandler processing");
    
    let mut processor = WebhookHandlerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WebhookHandlerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WebhookHandlerProcessor::new(false);
